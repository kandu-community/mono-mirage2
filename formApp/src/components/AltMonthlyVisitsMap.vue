  ...
  methods: {
    initMap() {
      ...
      this.tileLayer = L.tileLayer(
        //sets the tile layer, which you can think of as a collection of images which outline streets, rivers, city names, and other visual aspects of a map.
      ...
      this.marker = L.marker(["-29.6725216666667", "30.70266"])
        .addTo(this.map)
        .bindPopup("A pretty CSS3 popup.<br> Easily customizable.")
        .openPopup();
    },
    addMarkers(markerArray) {
      // Takes in object array and assigns markers accordingly
